...
import { Truck, Clock, CheckCircle, AlertTriangle, Loader2 } from 'lucide-react'
import {
...
export default function DashboardPage() {
  ...
  const getTerminalName = (id: string) =>
    terminals.find((t) => t.id === id)?.name || id
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div className="animate-fade-up" style={{ animationDelay: '0ms' }}>
              <StatCard
                ...
                value={overview?.totalTerminals ?? terminals.length}
                icon={Truck}
                color="blue"
              />
            </div>
            ...
            <div className="animate-fade-up" style={{ animationDelay: '160ms' }}>
              <StatCard
                ...
                value={overview?.pendingBookings ?? bookings.filter((b) => b.status === 'PENDING').length}
                icon={Clock}
                color="amber"
              />
            </div>
