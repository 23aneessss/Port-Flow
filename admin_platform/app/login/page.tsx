...
import { Eye, EyeOff, ShieldCheck, Anchor } from "lucide-react"
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-[#0F172A] text-white p-12 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 right-12 h-56 w-56 rounded-full bg-[#38BDF8]/8 blur-2xl" />
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="max-w-md text-slate-300 text-base font-[family-name:var(--font-roboto-condensed)]">
            Monitor terminals, manage operators, oversee transporters, and keep
            the entire port ecosystem running smoothly from a single dashboard.
          </p>
      ...
      <div className="flex flex-1 items-center justify-center bg-background px-6 py-12">
        <div className="w-full max-w-md animate-fade-in-up">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="admin@portflow.com"
                    value={email}
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            Access restricted to PortFlow administrators only.
          </p>
        </div>
      </div>
    </div>
